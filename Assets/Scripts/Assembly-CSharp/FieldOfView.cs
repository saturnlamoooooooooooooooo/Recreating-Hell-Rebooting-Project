...
public class FieldOfView : MonoBehaviour
{
	...
	public IEnumerator ChaseRun()
	{
		...
		{
			if (Orange.AI_Enemy == AI_Monster.AI_State.Patrol && anim.GetBool("walk") && anim.GetBool("run"))
			{
	...
	public void FixedUpdate()
	{
		...
		if (canSeePlayer)
		{
			base.gameObject.GetComponent<AI_Monster>().AI_Enemy = AI_Monster.AI_State.Chase;
		}
	}
