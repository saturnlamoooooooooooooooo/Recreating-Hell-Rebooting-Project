...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class FirstPersonController2 : MonoBehaviour
	{
		...
		public FirstPersonController2 scriptPlayer;

		public NavMeshAgent scriptAnimatronik;
		...
		private void Awake()
		{
			scriptAnimatronik = GameObject.FindGameObjectWithTag("Orange").GetComponent<NavMeshAgent>();
